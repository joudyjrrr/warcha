...
import WorkShopExpensesDialog from "./WorkShopExpensesDialog";
import { UseAxios } from "../store/constant/url";
function WorkShopExpenses({workshop}) {
 ...
 const [enter, setEnter] = useState(false);
  ...
  const getData = async () => {
   responce = await UseAxios({
    method: "get", 
    api: `getWorkShopExpens?workshop_id=${workshop}
...
`
  ...
  return (
   <div>
    <WorkShopExpensesDialog workshop={workshop } />
