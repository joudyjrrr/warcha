...
export default function CarTypeDialog() {
  ...
  try {
   ...
   data?.fuel&& formData.append("fuel", data.fuel);
   data?.gear&& formData.append("gear", data.gear);

    const response = await UseAxios({ method: "post", api: "createCarTypeCollection", data: formData });
