...
export default function ShiftDialog() {
  ...
  try {
   ...
   data?.start_time&& formData.append("start_time", data.start_time);
   data?.end_time&& formData.append("end_time", data.end_time);
    const response = await UseAxios({ method: "post", api: "createShift", data: formData });
